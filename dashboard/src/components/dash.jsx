  ...
  const renderMainContent = () => {
    switch (currentView) {
        ...
        return (
          <div className="p-8 space-y-8">
            ...
            <PipelineActions
              ...
              onViewResults={() => setCurrentView(DASH_VIEWS.RESULTS.id)}
              onClosePipeline={handleClosePipeline}
      ...
      case DASH_VIEWS.RESULTS.id:
              ...
              <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-600">
                ...
                {hasPreviousError ? (
                  ...
                  <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-green-400">
                      Last executed:{" "}
                      {new Date(
                        currentPipeline.lastExecutionDate
                      ).toLocaleString()}
                    </p>
                  </div>
                ) : null}
                ...
                {hasPreviousResult && (
                  <PipelineResults
                    ...
                    onEditPipeline={() => setCurrentView(DASH_VIEWS.BUILDER.id)}
                    onClosePipeline={handleClosePipeline}
                    pipelineName={currentPipeline?.name}
                  />
                )}
        ...
        // Fallback if no previous results
        return (
          <div className="p-8 space-y-8">
            <div className="text-center py-16">
              <div className="text-6xl mb-6">📊</div>
              ...
              <p className="text-slate-400 mb-8 max-w-md mx-auto">
                This pipeline hasn't been executed yet. Run it first to see
                results.
              </p>
              <div className="flex gap-4 justify-center">
                <button
